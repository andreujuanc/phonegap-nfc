...
namespace Pcsc
{
    ...
    /// </summary>
    internal class GetData : Iso7816.ApduCommand
    {
    ...
    /// </summary>
    internal class LoadKeys : Iso7816.ApduCommand
    {
    ...
    /// </summary>
    internal class GeneralAuthenticate : Iso7816.ApduCommand
    {
    ...
    /// </summary>
    internal class ReadBinary : Iso7816.ApduCommand
    {
    ...
    /// </summary>
    internal class UpdateBinary : Iso7816.ApduCommand
    {
        public UpdateBinary(ushort address, [ReadOnlyArray]byte[] dataToWrite)
    ...
    /// </summary>
    internal class GetHistoricalBytes : GetData
    {
    ...
    /// </summary>
    internal class ManageSession : Iso7816.ApduCommand
    {
    ...
    /// </summary>
    internal class TransparentExchange : Iso7816.ApduCommand
    {
    ...
    /// </summary>
    internal class IncrementDecrement : Iso7816.ApduCommand
    {
        public enum DataObjectType
        {
            Increment = 0xA0,
    ...
    /// PCSC Apdu response
    /// </summary>
    internal class ApduResponse : Iso7816.ApduResponse
    {
        public ApduResponse()
            : base()
        {
    ...
    /// </summary>
    internal class ManageSessionResponse : Iso7816.ApduResponse
    {
        public enum DataObjectType
        {
    ...
    /// </summary>
    internal class TransparentExchangeResponse : Iso7816.ApduResponse
    {
        internal enum DataObjectType
        {
            GenericErrorStatus = 0xC0,
        ...
        internal TransparentExchangeResponse()
            : base()
        {
        }
        public bool SucceededTransparent
        {
            get
            {
                if (base.Succeeded)
