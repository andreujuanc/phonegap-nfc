...
namespace Pcsc.Iso7816
{
    ...
    {
        public ApduCommand(byte cla, byte ins, byte p1, byte p2, [ReadOnlyArray]byte[] commandData, byte? le)
        {
    ...
    {
        internal const byte TAG_MULTI_BYTE_MASK = 0x1F;
        internal const byte TAG_COMPREHENSION_MASK = 0x80;
        internal const byte TAG_LENGTH_MULTI_BYTE_MASK = 0x80;
        ...
        public void ExtractResponse(IBuffer response)
        {
    ...
    /// </summary>
    internal class  SelectCommand : ApduCommand
    {
