...
namespace Pcsc.Common
{
    ...
    {
        internal const byte NIBBLE_SIZE = 4;
        /// <summary>
        ...
        /// </returns>
        public static byte HiNibble(this byte valueByte)
        {
            return (byte)(valueByte >> 4);
        }
        /// <summary>
        ...
        /// </returns>
        public static byte LowNibble(this byte valueByte)
        {
            return (byte)(valueByte & 0x0F);
        }
    }
}
