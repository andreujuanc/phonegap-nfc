...
namespace Pcsc.Desfire
{
    ...
    /// </summary>
    internal class  DesfireCommand : Iso7816.ApduCommand
    {
        public byte Command
        {
            set { base.INS = value; }
    ...
    /// </summary>
    internal class  DesfireResponse : Iso7816.ApduResponse
    {
        public DesfireResponse()
            : base()
        { }
        public string SWTranslationDesfire
        {
            get
            {
                if (SW1 != 0x91)
