...
namespace Pcsc.MifareStandard
{
    ...
    /// </summary>
    internal class  Write : Pcsc.UpdateBinary
    {
        public byte[] Data
        {
    ...
    /// </summary>
    internal class  GetUid : Pcsc.GetUid
    {
        public GetUid()
            : base()
        {
    ...
    /// </summary>
    internal class  GetHistoricalBytes : Pcsc.GetHistoricalBytes
    {
    ...
    /// </summary>
    internal class  LoadKey : Pcsc.LoadKeys
    {
    ...
    /// Mifare Standard GetHistoricalBytes command
    /// </summary>
    internal class  GeneralAuthenticate : Pcsc.GeneralAuthenticate
    {
    ...
    /// </summary>
    internal class  ApduResponse : Pcsc.ApduResponse
    {
        public ApduResponse()
            : base()
        {
