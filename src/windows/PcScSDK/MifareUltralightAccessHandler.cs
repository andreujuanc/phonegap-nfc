...
namespace MifareUltralight
{
    ...
    public class AccessHandler
    {
        ...
        public async Task<byte[]> ReadAsync(byte pageAddress)
        {
            ...
            {
                throw new Exception("Failure reading MIFARE Ultralight card, " + apduRes.ToStringSelect());
            }
        ...
        public async void WriteAsync(byte pageAddress, byte[] data)
        {
            ...
            if (!apduRes.Succeeded)
            {
                throw new Exception("Failure writing MIFARE Ultralight card, " + apduRes.ToStringSelect());
            }
        }
        /// <summary>
        ...
        public async Task<byte[]> GetUidAsync()
        {
            ...
            if (!apduRes.Succeeded)
            {
                throw new Exception("Failure getting UID of MIFARE Ultralight card, " + apduRes.ToStringSelect());
            }
