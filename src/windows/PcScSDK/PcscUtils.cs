...
namespace Pcsc
{
    public static class SmartCardConnectionExtension
    {
        ...
        public static async Task<byte[]> TransparentExchangeAsync(this SmartCardConnection connection, byte[] commandData)
        {
            ...
            {
                throw new Exception("Failure to start transparent session, " + apduRes.ToStringSelect());
            }
            ...
            using (DataWriter dataWriter = new DataWriter())
            {
                ...
                {
                    throw new Exception("Failure transceive with card, " + apduRes1.ToStringSelect());
                }
            ...
            {
                throw new Exception("Failure to end transparent session, " + apduRes2.ToStringSelect());
            }
