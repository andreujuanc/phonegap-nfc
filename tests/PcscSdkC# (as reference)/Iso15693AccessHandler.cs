...
namespace Iso15693
{
    ...
    public class AccessHandler
    {
        ...
        public async Task<byte[]> ReadAsync(byte blockNumber)
        {
            ...
            {
                throw new Exception("Failure reading Iso15693 card, " + apduRes.ToStringSelect());
            }
        ...
        public async Task WriteAsync(byte blockNumber, byte[] dataToWrite)
        {
            ...
            if (!apduRes.Succeeded)
            {
                throw new Exception("Failure writing Iso15693 card, " + apduRes.ToStringSelect());
            }
        }
        /// <summary>
        ...
        public async Task<byte[]> GetUidAsync()
        {
            ...
            if (!apduRes.Succeeded)
            {
                throw new Exception("Failure getting UID of Iso15693 card, " + apduRes.ToStringSelect());
            }
